...
class StaticUuidGeneratorTest {
    ...
    public void testGenerateUuid() {
        StaticUuidGenerator generator = StaticUuidGenerator.builder().build();
        assertEquals("00000000-0000-0000-0000-000000000000", generator.generateUuid());
    }

    @Test
    public void testGenerateUuidSpecific() {
        StaticUuidGenerator generator = StaticUuidGenerator.builder().uuid("11111111-1111-1111-1111-111111111111")
                .build();
